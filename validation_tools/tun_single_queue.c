...
#define RECEIVED_PACKET_SIZE 1432 //Should be PACKET_SIZE + 32
...
{
    if(argc != 3) {
        fprintf(stderr, "Usage: ./tun_single_queue.o wait_time_nanos run_time_ns\n");
        return 1;
    }
